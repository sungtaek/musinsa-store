...
public class ProductApiTest {
  ...
  public void getHighestPricedSetSuccess() throws Exception {
    ...
    mockMvc.perform(get("/api/v1/products/set")
        ...
        .andExpect(jsonPath("$.code", equalTo(ResultCode.SUCCESS.getCode())))
        .andExpect(jsonPath("$.data.lowestPrice.products", hasSize(8)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'TOPS')].brandName", contains("I")))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'TOPS')].price", contains(11400)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'OUTER')].brandName", contains("F")))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'OUTER')].price", contains(7200)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'PANTS')].brandName", contains("A")))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'PANTS')].price", contains(4200)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'SNEAKERS')].brandName", contains("E")))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'SNEAKERS')].price", contains(9900)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'BAGS')].brandName", contains("D")))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'BAGS')].price", contains(2500)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'HATS')].brandName", contains("B")))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'HATS')].price", contains(2000)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'SOCKS')].brandName", contains("D")))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'SOCKS')].price", contains(2400)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'ACCESSORIES')].brandName", contains("I")))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'ACCESSORIES')].price", contains(2400)))
        .andExpect(jsonPath("$.data.lowestPrice.totalPrice", equalTo(42000)))
        .andReturn();
  }
  ...
  public void getHighestPricedSetForSingleBrandSuccess() throws Exception {
    ...
    mockMvc.perform(get("/api/v1/products/set")
        ...
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.code", equalTo(ResultCode.SUCCESS.getCode())))
        .andExpect(jsonPath("$.data.lowestPrice.brandName", equalTo("F")))
        .andExpect(jsonPath("$.data.lowestPrice.products", hasSize(8)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'TOPS')].price", contains(11200)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'OUTER')].price", contains(7200)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'PANTS')].price", contains(4000)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'SNEAKERS')].price", contains(9300)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'BAGS')].price", contains(2100)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'HATS')].price", contains(1600)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'SOCKS')].price", contains(2300)))
        .andExpect(jsonPath("$.data.lowestPrice.products[?(@.category == 'ACCESSORIES')].price", contains(1900)))
        .andExpect(jsonPath("$.data.lowestPrice.totalPrice", equalTo(39600)))
        .andReturn();
  }
